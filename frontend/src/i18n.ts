...
export const translations = {
  en: {
    ...
    summoner: {
      ...
      gamesRanking: "Ranking - Most Games",
      classWinRate: "WR Against Classes",
      ...
      filters: {
        ...
        worstWinRate: "Worst WR",
        bestWinRate: "Best WR",
        loadingMatchups: "Loading matchups...",
        matchupsError: "Unable to load matchups.",
        noMatches: "No matchups found for these filters.",
      },
    },
    championClasses: {
      Assassin: "Assassin",
  ...
  pt: {
    ...
    summoner: {
      ...
      gamesRanking: "Ranking - Mais Jogos",
      classWinRate: "WR Contra Classes",
      ...
      filters: {
        ...
        worstWinRate: "Pior WR",
        bestWinRate: "Melhor WR",
        loadingMatchups: "Carregando matchups...",
        matchupsError: "Não foi possível carregar os matchups.",
        noMatches: "Nenhum matchup encontrado com esses filtros.",
      },
    },
    championClasses: {
      Assassin: "Assassino",
